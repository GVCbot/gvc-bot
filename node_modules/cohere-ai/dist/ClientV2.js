...
class CohereClientV2 {
    constructor(_options) {
        ...
        this.options = (0, OptionalBearerAuthProvider_1.withOptionalAuth)(this._options);
        this.client = new Client_2.CohereClient(this.options);
        this.clientV2 = new Client_1.V2Client(this.options);
